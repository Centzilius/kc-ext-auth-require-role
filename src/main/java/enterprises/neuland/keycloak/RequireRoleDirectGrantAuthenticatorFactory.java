...
public class RequireRoleDirectGrantAuthenticatorFactory implements AuthenticatorFactory {
    public static final RequireRoleAuthenticator ROLE_AUTHENTICATOR = new RequireRoleDirectGrantAuthenticator();
    public static final String PROVIDER_ID = "require-role-direct-grant";
